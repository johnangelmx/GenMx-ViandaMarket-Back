...
-- ########### RIBEYE ###########
-- Ribeye precio 5750
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Ribeye', '5750',
           ...
           '1', '5', '1', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899814/ViandaMarket/Ribeye-wagyujapones3_a3zdff.jpg');

-- Ribeye precio 3850
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Ribeye', '3850',
           'El preferido de muchos, esto gracias a su balance de sabor, suavidad y cantidad de grasa, es un corte sin hueso que proviene de la parte superior de las costillas.',
           '1', '3', '2', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899816/ViandaMarket/Ribeye-wagyustoneaxe3_oki70a.jpg');

-- Ribeye  precio 3170
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Ribeye', '3170',
           'El preferido de muchos, esto gracias a su balance de sabor, suavidad y cantidad de grasa, es un corte sin hueso que proviene de la parte superior de las costillas.',
           '1', '3', '3', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899806/ViandaMarket/NewYork_-wagyustoneaxe3_wgtwty.jpg');

-- Ribeye precio 1250
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Ribeye', '1250',
           'El preferido de muchos, esto gracias a su balance de sabor, suavidad y cantidad de grasa, es un corte sin hueso que proviene de la parte superior de las costillas.',
           '1', '3', '4', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899806/ViandaMarket/NewYork_-wagyustoneaxe3_wgtwty.jpg');
...
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Ribeye', '698',
           'El preferido de muchos, esto gracias a su balance de sabor, suavidad y cantidad de grasa, es un corte sin hueso que proviene de la parte superior de las costillas.',
           '1', '3', '7', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899813/ViandaMarket/Ribeye-choicemx_ssi9q1.jpg');
...
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('New York', '5750',
           ...
           '1', '3', '1', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899806/ViandaMarket/NewYork_-wagyustoneaxe3_wgtwty.jpg');
-- Newyork precio 3790
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('New York', '3790',
           'Es un corte muy bien valorado, viene del lomo de la res. Es popular por su gran suavidad y poca grasa.',
           '1', '3', '2', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899806/ViandaMarket/NewYork_-wagyustoneaxe2_gwu63x.jpg');
-- Newyork precio 3150
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('New York', '3150',
           'Es un corte muy bien valorado, viene del lomo de la res. Es popular por su gran suavidad y poca grasa.',
...
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('New York', '456',
           'Es un corte muy bien valorado, viene del lomo de la res. Es popular por su gran suavidad y poca grasa.',
           '1', '3', '7', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899806/ViandaMarket/NewYork_-wagyustoneaxe3_wgtwty.jpg');
-- ########### PORTERHOUSE ###########
-- Porterhouse 3500
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
...
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Picaña', '500',
           'Popularizado por su reconocimiento en espadas Brasileñas, es un corte de gran sabor y suavidad, excelente para asar en laminas pero tambien para el ahumado.',
           '1', '3', '6', '0','https://res.cloudinary.com/dw1mig7ts/image/upload/v1682899806/ViandaMarket/NewYork_-wagyustoneaxe3_wgtwty.jpg');
-- PICAÑA 367
INSERT INTO cortes (nombre, precio, descripcion_corte, disponibilidad, cantidad_disponible, idcalidades, idgramos,imagen)
    VALUE ('Picaña', '367',
           'Popularizado por su reconocimiento en espadas Brasileñas, es un corte de gran sabor y suavidad, excelente para asar en laminas pero tambien para el ahumado.',
...
INSERT INTO complementos (idcomplementos, nombre, disponibilidad, cantidad_disponible, descripcion_complemento, precio)
    VALUE (1, 'Chistorra', 0, 1,
           'Este producto similar a la salchicha parrillera sudamericana pero con diferencias en el sabor. Se puede decir que es un producto con sabores más españoles dados por los condimentos utilizados.',
           248);
INSERT INTO complementos (idcomplementos, nombre, disponibilidad, cantidad_disponible, descripcion_complemento, precio)
    VALUE (2, 'Chorizo Argentino', 1, 1,
           'También conocido como chorizo criollo, utilizado en algunas ocasiones para chori panes, ideal para asarlo o a la parrilla.',
           204);
INSERT INTO complementos (idcomplementos, nombre, disponibilidad, cantidad_disponible, descripcion_complemento, precio)
    VALUE (3, 'Termómetro', 1, 1,
           'El nuevo termómetro de alimentos de lectura rápida proporciona lecturas precisas de la temperatura de los alimentos en segundos. El termómetro cabe cómodamente en su bolsillo.',
           420);
SELECT *
