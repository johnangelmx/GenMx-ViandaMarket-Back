...
SELECT * FROM vianda_market_db.cortes;
...
SELECT * FROM vianda_market_db.usuarios;

-- ########### TABLA COMPLEMENTOS ###########


INSERT INTO complementos (idcomplementos, nombre, disponibilidad, cantidad_disponible, descripcion_complemento, precio)
VALUE (1,'Chistorra',0,1,'Este producto similar a la salchicha parrillera sudamericana pero con diferencias en el sabor. Se puede decir que es un producto con sabores más españoles dados por los condimentos utilizados.',248);
INSERT INTO complementos (idcomplementos,nombre, disponibilidad, cantidad_disponible, descripcion_complemento, precio)
VALUE (2,'Chorizo Argentino',1,1,'También conocido como chorizo criollo, utilizado en algunas ocasiones para chori panes, ideal para asarlo o a la parrilla.',204);
INSERT INTO complementos (idcomplementos,nombre, disponibilidad, cantidad_disponible, descripcion_complemento, precio)
VALUE (3,'Termómetro',1,1,'El nuevo termómetro de alimentos de lectura rápida proporciona lecturas precisas de la temperatura de los alimentos en segundos. El termómetro cabe cómodamente en su bolsillo.',420);
SELECT * FROM vianda_market_db.complementos;
...
VALUES (350,1), (350,6), (370,1), (370,6), (400,1), (400,6), 
       ...
       (770,11),(800,11),
        ...
        (330,9),(350,9),(370,9),
         (900,12),(1000,12),
         (720,14),(750,14),
          (1500,17),(2000,17),(2500,17),
           (400,20),(700,20),
           (380,5),(400,5),(420,5),(450,5),
...
SELECT * FROM vianda_market_db.gramos;
...
'A5 (BMS 8-11)');
INSERT INTO calidades (marca, pais, descripcion_marca, calidad)
VALUE ('Stone Axe', 'Australia', 'Stone Axe es un Wagyu Fullblood Australiano con BMS 9+, lo mas alto en la escala de marmoleo australiana.',
 'BMS 9+');
INSERT INTO calidades (marca, pais, descripcion_marca, calidad)
VALUE ('Margaret River', 'Australia', 'Margaret River es un Wagyu Pure Bred con BMS 8-9, su genetica Wagyu esta en el 94%, un marmoleo y sabor excepcional.', 
'BMS 8-9');
INSERT INTO calidades (marca, pais, descripcion_marca, calidad)
VALUE ('Excel', 'USA / Canada', 'Excel es uno de los mayores comercializadores de carne en norte america, sin duda, una garantia obtener sus productos.', 
'Prime (BMS 4-5)');
INSERT INTO calidades (marca, pais, descripcion_marca, calidad)
VALUE ('CAB', 'USA / Canada', 'CAB con sus 10 normas adicionales a la USDA genera una gran confianza a garantia a sus clientes, una excelente opcion para saborear lo mejor de USA y Canada.', 
'Prime (BMS 4-5)');
INSERT INTO calidades ( marca, pais, descripcion_marca, calidad)
VALUE ('Sterling Silver', 'USA / Canada', 'Famosa por sus productos High Choice, lo mejor dentro de su categoria. Su proceso de añejamiento de 21 potencializa el sabor y suavidad de la carne.', 
'High Choice (BMS 3)');
INSERT INTO calidades (marca, pais, descripcion_marca, calidad)
VALUE (' ', 'México', 'El producto que manejamos en esta categoria proviene de Sonora, con un excelente sabor, calidad y textura. Su marmoleo es similar a los productos Choice y Prime.',
 'Nacional');
SELECT * FROM vianda_market_db.calidades;